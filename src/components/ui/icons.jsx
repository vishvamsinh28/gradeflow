function make(path, displayName) {
  const Component = ({ size = 16, ...props }) => (
    <svg
      width={size}
      height={size}
      viewBox="0 0 24 24"
...
export const IconSparkle = make(
  <>
    <path d="M12 3.5 13.7 9l5.3 1.8-5.3 1.9L12 18.2 10.3 12.7 5 10.8 10.3 9z" />
    <path d="M18.5 3.5v3" />
    <path d="M20 5h-3" />
  </>,
  "IconSparkle",
...
export const IconCheckCircle = make(
  <>
    <circle cx="12" cy="12" r="8.5" />
    <path d="m8.3 12.2 2.5 2.5 4.9-4.9" />
  </>,
  "IconCheckCircle",
);
export const IconMinusCircle = make(
  <>
    <circle cx="12" cy="12" r="8.5" />
    <path d="M8.5 12h7" />
  </>,
...
export const IconHome = make(
  <>
    ...
    <path d="M6 9.4V19a1.5 1.5 0 0 0 1.5 1.5h9A1.5 1.5 0 0 0 18 19V9.4" />
  </>,
  "IconHome",
);
...
export const IconEyeOff = make(
  <>
    <path d="M9.6 6.1A8.9 8.9 0 0 1 12 5.8c6 0 9.5 6.2 9.5 6.2a17 17 0 0 1-2.9 3.6" />
    <path d="M6.2 8A17 17 0 0 0 2.5 12S6 18.2 12 18.2a8.7 8.7 0 0 0 3.4-.66" />
...
export function Logo({ size = 22, className = "" }) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M3.4 12.8 8.7 18.2" stroke="var(--ink)" strokeWidth="3.1" strokeLinecap="round" />
      <path d="M8.7 18.2 20.6 4.6" stroke="var(--accent)" strokeWidth="3.1" strokeLinecap="round" />
    </svg>
  );
}
