...
export function AppFrame({ children, label, className, minWidth = 600 }) {
  return (
    <div
      className={cx(
      ...
      <table className="w-full border-separate border-spacing-0 text-[11.5px]">
        <thead>
          <tr className="text-[9.5px] uppercase tracking-[0.07em] text-ink-3">
            ...
            <th className="border-b border-line px-3 py-1.5 text-right font-semibold">
              Attendance
            </th>
          </tr>
        </thead>
        <tbody>
          {MARKS.map((row) => (
            <tr key={row.id}>
              <td className="border-b border-line px-3 py-[7px] font-medium text-ink">
                {row.name}
              </td>
              ...
              <td
                className={cx(
                  "border-b border-line py-[7px] text-right font-mono tnum",
                  markClass(row.m),
                )}
              >
                {row.m}
      ...
      <div className="mb-2.5 grid grid-cols-4 divide-x divide-line rounded-lg border border-line">
        {[
          ...
          <div key={label} className="px-2 py-1.5">
            <p className="text-[8.5px] font-medium uppercase tracking-[0.06em] text-ink-3">
              {label}
            </p>
    ...
    <div>
      ...
      <ul className="divide-y divide-line">
        {[
          ...
          <li key={file} className="flex items-center gap-2 px-3 py-[7px]">
