...
function useTicker(onTick, ms, ref) {
  useEffect(() => {
 ...
 */
export function LiveGrading({ on = "night" }) {
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between">
        ...
        <span className={cx("font-mono text-[12px] tnum", dark ? "text-white/60" : "text-ink-3")}>
          {graded}/{total}
        </span>
      </div>
