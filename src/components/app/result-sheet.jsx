 ...
 */
function SheetViewer({ submission }) {
...
export function ResultSheet({ submission, student, test, onClose, onStep, position }) {
  const toast = useToast();
  const [draft, setDraft] = useState("");
  const [pane, setPane] = useState("marks");
              ...
              <div>
                ...
                <ul className="divide-y divide-line border-t border-line">
                  {submission.questions.map((question) => {
                    const ratio =
                      question.out_of > 0 ? (question.awarded / question.out_of) * 100 : 0;
                    return (
