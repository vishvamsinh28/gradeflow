...
function BentoCard({ kicker, title, body, visual, className, delay }) {
  return (
    <div
      data-reveal
      style={{
      ...
      <div className="mx-auto w-full max-w-[1120px]">
        ...
        >
          <Segmented
            ...
            options={Object.keys(SURFACES).map((key) => ({
              value: key,
    ...
    <footer className="border-t border-line px-5 py-8 sm:px-8">
      <div className="mx-auto flex w-full max-w-[1120px] flex-wrap items-center gap-x-6 gap-y-3">
        <Link href="/" className="flex items-center gap-2">
          <Logo size={18} />
          <span className="text-[13.5px] font-semibold tracking-[-0.028em] text-ink">
            GradeFlow
          </span>
        </Link>
