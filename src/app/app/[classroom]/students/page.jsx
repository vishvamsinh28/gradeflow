...
import { SortHeader, TD, TH, compareValues, nextSort } from "@/components/app/table";
      ...
      return {
        ...
        average:
          percents.length > 0
            ...
            : null,
        attendance: classroom.tests.length > 0 ? (present / classroom.tests.length) * 100 : null,
      };
    });
  }, [classroom]);
    ...
    <div>
      <div className="mb-4 flex flex-wrap items-center gap-2">
        ...
        <span className="text-[12.5px] text-ink-3">
          {query
            ? `${visible.length} of ${classroom.students.length}`
            : pluralize(classroom.students.length, "student")}
        </span>
      ...
      <div className="overflow-hidden rounded-xl border border-line bg-surface">
        {classroom.students.length === 0 ? (
          ...
          <EmptyState
            title="No matches"
            description={`Nothing in this classroom matches "${query}".`}
          />
        ) : (
              ...
              <tbody>
                {visible.map(({ student, graded, average, attendance }) => (
                  ...
                  >
                    ...
                    <td
                      className={cx(TD, "pr-4 text-right font-mono text-[12.5px] text-ink-2 tnum")}
                    >
