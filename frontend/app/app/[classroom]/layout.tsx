...
const TABS = [
  { segment: "", label: "Overview", icon: <IconHome size={14} /> },
  { segment: "students", label: "Students", icon: <IconUsers size={14} /> },
  { segment: "tests", label: "Tests", icon: <IconCalendar size={14} /> },
  { segment: "marks", label: "Marks", icon: <IconTable size={14} /> },
];
    ...
    <div>
      <div className="border-b border-line bg-surface">
        <div className="mx-auto w-full max-w-[1360px] px-4 pt-6 sm:px-6">
          ...
          <nav className="no-scrollbar -mb-px mt-5 flex gap-0.5 overflow-x-auto" aria-label="Classroom sections">
            {TABS.map((tab) => {
